...
def train_target(args):
    ...
    args.modelpath = args.src_dir + '/source_F.pt'
    netF.load_state_dict(torch.load(args.modelpath))
    args.modelpath = args.src_dir + '/source_B.pt'
    netB.load_state_dict(torch.load(args.modelpath))
    args.modelpath = args.src_dir + '/source_C.pt'
    ...
    while iter_num < max_iter:
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            log_str = 'Task: {}2{}, Iter:{}/{}; Accuracy = {:.2f}%'.format(args.s, args.t, iter_num, max_iter, acc)
...
if __name__ == "__main__":
    ...
    args.src_dir = path = osp.join(args.output_src, 'seed' + str(args.seed), 'source', args.s)
    args.output_dir = osp.join(args.output_src, 'seed' + str(args.seed), 'adapt_single', '{}2{}'.format(args.s, args.t))
